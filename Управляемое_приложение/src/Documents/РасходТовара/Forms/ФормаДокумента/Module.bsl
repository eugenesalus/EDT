...
Процедура ОрганизацияАвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Текст) Тогда
		...
		СтандартнаяОбработка = Ложь;
		ДанныеВыбора = ПодобратьОрганизации();
...
Функция ПодобратьОрганизации() 
	...
	Запрос.УстановитьПараметр("Наименование", "ООО ""Товары""");
...
&НаКлиенте
Процедура ПокупательОкончаниеВводаТекста(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, СтандартнаяОбработка)
	// Вставить содержимое обработчика.
	ш = 	1;
КонецПроцедуры
