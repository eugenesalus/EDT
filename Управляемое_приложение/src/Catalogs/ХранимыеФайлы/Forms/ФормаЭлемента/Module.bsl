...
Процедура ВыбратьФайлСДискаИЗаписать()
	ДопПараметры = Объект.Ссылка.Пустая();
	ПослеПомещенияФайла = Новый ОписаниеОповещения("ВыбратьФайлСДискаИЗаписатьЗавершение", ЭтотОбъект, ДопПараметры);
	...
	НачатьПомещениеФайлаНаСервер(ПослеПомещенияФайла, ОХодеПомещенияФайла, ПередПомещениемФайла); 
КонецПроцедуры
...
&НаКлиенте
Процедура ВыбратьФайлСДискаИЗаписатьЗавершение(ОписаниеПомещенногоФайла, НовыйОбъект) Экспорт
...
Процедура ПослеПолучениеКаталога(Каталог, ДопПараметры) Экспорт
	...
	НачатьПомещениеФайловНаСервер(ПослеПомещенияФайлов);  
...
Процедура ДобавитьСохраненноеАудиоИЗаписать(Команда)
	...
	ПослеПолучениеКаталога = Новый ОписаниеОповещения("ПослеПолучениеКаталога", ЭтотОбъект);
	НачатьПолучениеКаталогаБиблиотекиМобильногоУстройства(ПослеПолучениеКаталога, ТипКаталога);
...
&НаКлиенте
Процедура ПоместитьЗашифрованныйПослеПомещенияБезРасширения(ВыбранныйФайл, Контекст) Экспорт
	// Копи-паст из ПоместитьЗашифрованныйНаСервер
	Если ВыбранныйФайл = Неопределено Тогда
		Возврат;
	КонецЕсли;	

	Контекст.ИсходныеДанныеДляШифрования = ПолучитьИзВременногоХранилища(ВыбранныйФайл.Адрес);
	ПоместитьЗашифрованныеДанныеКонтекста(ВыбранныйФайл.СсылкаНаФайл.Имя, Контекст);
