...
#Если МобильныйКлиент Тогда
	...
	ИначеЕсли Позиция = 0 Тогда
		...
		КонецЦикла;
		ОписаниеОповещения = Новый ОписаниеОповещения("ПослеВыбора", ЭтотОбъект, ТекущийДокумент);
...
#Иначе
	...
	Если НЕ ДанныеСобытия.Anchor = Неопределено Тогда
		...
		ИначеЕсли ДанныеСобытия.Anchor.id = "Разделы" Тогда
...
&НаКлиенте
Процедура ПослеВыбора(ВыбранныйЭлемент, ДополнительныеПараметры) Экспорт
	Если ВыбранныйЭлемент <> Неопределено Тогда
		ПоказатьРаздел(ДополнительныеПараметры, ВыбранныйЭлемент.Значение);
	КонецЕсли;
КонецПроцедуры
